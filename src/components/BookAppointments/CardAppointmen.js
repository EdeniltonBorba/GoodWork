        ...
        <div>
            <form className="quote-form">
                <div className="grid-container">
                    <div className="grid-x grid-padding-x" color="#3f51b5" style={CardStyle}>
                        ...
                        <div className="cell">
                            ...
                            <Link to="/Thanks">
                                ...
                                <div className="cell small-12 quote-form__button" style={getPrice}><button className={classes.submit} type="submit"
                                    ...
                                    data-mixpanel-service-name="other_handyman_service" data-mixpanel-zipcode="">
                                    Get a Price
                            </button>
                                </div>
                            </Link>
                ...
                <p className="grid-container quote-form-description" style={terms}>By signing and clicking Get a Price, you affirm you have read
            and agree to the <span>GoodWork Terms</span>, and you agree and authorize GoodWork and its
